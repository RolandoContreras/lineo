...
class video_message_atributos{	
    var $video_message_id='';
    var $video_id='';
    var $customer_id='';
    var $date='';
    var $message='';
...
class Video_message_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'video_message';
	$this->table_id = 'video_message_id';
        $this->video_message_id='';
        $this->video_id='';
        $this->customer_id='';
        $this->date='';
        $this->message='';
        $this->respose='';
        $this->active='';
	$this->fields = new video_message_atributos();
    }   
