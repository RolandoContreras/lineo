        ...
        include ("vendor/autoload.php");
            ...
            $html = '
                <div style="align-content: center;margin:auto;">
                    ...
                    <h4 style="font-size: 15px;position:absolute;margin-top:-420px;left:350px;font-family:sans-serif;letter-spacing: 0.5pt">CONTENIDO &nbsp;DEL&nbsp; CURSO</h4>
                    ...
                    <div style="font-size: 12px;position:absolute;margin-top:-380px;left:350px;font-family:sans-serif;text-align: center;">
                        ...
                        <P style="font-size: 13px;font-family:sans-serif;left:30px;text-align: left !important;letter-spacing: 0.5pt">TOTAL DE HORAS: &nbsp;&nbsp;<b>'.$total_hours.' HORAS</b></p>
                    </div>
