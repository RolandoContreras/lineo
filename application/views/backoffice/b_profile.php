                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="name" value="<?php echo formato_fecha($obj_customer->date); ?>" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="<?php echo site_url().'backoffice/profile/upload';?>" class="dropzone" method="post">
                                                            <div class="fallback">
                                                                <input name="file" name="file" type="file" multiple="1" />
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
<script src='<?php echo site_url() . 'static/backoffice/js/dropzone-amd-module.min.js';?>'></script>
