          ...
          <div class=wpb_wrapper>
            <div class="thim-sc-icon-box layout-1 default">
              <div class=icon-box-wrapper style>
                <div class=box-icon>
                    <img class=image-upload src=<?php echo site_url().'static/page_front/images/group-5.jpg';?> width=128 height=129 alt="LA MEJOR EXPERIENCIA EN EDUCACIÓN">
                </div>
                <div
                  class=box-content>
                  <h3 class="title">LA MEJOR EXPERIENCIA EN EDUCACIÓN</h3>
                  <div class=description>
                    <p>Plataforma dedicada a cada curso enfocado en la experiencia de aprendizaje</p>
                  </div>
              </div>
            </div>
          </div>
      ...
      <div class=vc_column-inner>
        <div class=wpb_wrapper>
          <div class="thim-sc-icon-box layout-1 default">
            <div class=icon-box-wrapper style>
              <div class=box-icon>
                  <img class=image-upload src="<?php echo site_url().'static/page_front/images/group-3.jpg';?>" width=120 height=129 alt="IDEA INNOVADORA EN EDUCACIÓN">              
              </div>
              <div
                class=box-content>
                <h3 class="title">IDEA INNOVADORA EN EDUCACIÓN</h3>
                <div class=description>
                  <p>Una presentación eficaz que destaca el aprendizaje por metas</p>
                </div>
            </div>
          </div>
        </div>
    ...
    <div class=vc_column-inner>
      <div class=wpb_wrapper>
        <div class="thim-sc-icon-box layout-1 default">
          <div class=icon-box-wrapper style>
            <div class=box-icon>
                <img class=image-upload src="<?php echo site_url().'static/page_front/images/group-4.jpg';?>" width=128 height=129 alt="SÉ UN EXPERTO EN LA MATERIA">
            </div>
            <div
              class=box-content>
              <h3 class="title">SÉ UN EXPERTO EN LA MATERIA</h3>
              <div class=description>
                <p>Tener éxito requiere experiencia en una variedad de habilidades</p>
              </div>
          </div>
        </div>
      </div>
