                        ...
                        <div class="container">
                            <div class="navxtBreads"> 
                                <span property="itemListElement">
                                    ...
                                    <span property="name" title="Cursos">Política de privacidad y cookies</span>
                                </span>
                            </div>
                        </div>
                    </div>
                                                                ...
                                                                <div id="bbpress-forums" class="bbpress-wrapper">
                                                                    ...
                                                                    <ul id="forums-list-0" class="bbp-forums">
                                                                        ...
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Política de privacidad y Cookies</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                                        El presente Política de Privacidad establece los términos en que U-Linex usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo con dichos cambios.
                                                                                    </div>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Información que es recogida</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                        ...
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Uso de la información recogida</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                                        Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para mantener un registro de usuarios, de pedidos en caso que aplique, y mejorar nuestros productos y servicios.  Es posible que sean enviados correos electrónicos periódicamente a través de nuestro sitio con ofertas especiales, nuevos productos y otra información publicitaria que consideremos relevante para usted o que pueda brindarle algún beneficio, estos correos electrónicos serán enviados a la dirección que usted proporcione y podrán ser cancelados en cualquier momento.
                                                                                        U-Linex está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
                                                                                    </div>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Cookies</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                        ...
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Enlaces a Terceros</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                        ...
                                                                        <li class="bbp-body">
                                                                            <ul class="loop-item-0 bbp-forum-status-open bbp-forum-visibility-publish odd post-4289 forum type-forum status-publish hentry pmpro-has-access">
                                                                                <li class="bbp-forum-info" style="width: 100%;">
                                                                                    <a class="bbp-forum-title"><b>Control de su información personal</b></a>
                                                                                    <div class="bbp-forum-content">
                                                                                        En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro sitio web.  Cada vez que se le solicite rellenar un formulario, como el de alta de usuario, puede marcar o desmarcar la opción de recibir información por correo electrónico.  En caso de que haya marcado la opción de recibir nuestro boletín o publicidad usted puede cancelarla en cualquier momento.
                                                                                        <br/>
                                                                                        Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su consentimiento, salvo que sea requerido por un juez con un orden judicial.
                                                                                        <br/>
                                                                                        U-Linex Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
                                                                                    </div>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
