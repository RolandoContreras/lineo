                                        ...
                                        <div class="pull-right">
                                            <div class="header_top_bar_socs">
                                                <ul class="clearfix">
                                                    ...
                                                    <li>
                                                        <a  href="https://api.whatsapp.com/send?phone=51923313490" title="Whatsapp U-Linex" target="_blank" rel="noopener">
                    ...
                    <div class="header_top">
                        <div class="logo-unit">
                            <a href="<?php echo site_url(); ?>"> 
                                <img class="img-responsive logo_transparent_static visible logo" src="<?php echo site_url() . 'static/page_front/images/logo/logo-b.png'; ?>" alt="U-linex Logo"/> 
                            </a>
                        </div>
