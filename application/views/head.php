<head>
    ...
    <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/autoptimize_8aaef.css';?>" media="all">
    <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/autoptimize_da4b.css';?>" media="all">
    <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/my_style.css?1';?>" media="all">
    <!-- favicon-->
    ...
    <!--//swetaler2-->
    <link href="//cdn.jsdelivr.net/npm/@sweetalert2/theme-dark@3/dark.css" rel="stylesheet" media='all'>
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@9/dist/sweetalert2.min.js"></script>
    <link rel="canonical" href="<?php echo site_url();?>"/>
    <meta name="google-site-verification" content="cdP1tLyOGY0_n01Aai4sYIVk_YS93XRh8mC3-ABNkdg" />
    <!-- Facebook Pixel Code -->
<script>
