 <?php $cart = count($this->cart->contents());
               if($cart > 0){ ?>
                    <div class="widget woocommerce widget_shopping_cart">
                        <div class="minicart_hover white" id=header-mini-cart>
                            ...
                            <div class="widget_shopping_cart_content" style="padding-top: 10px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">
                              <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                  ...
                                  <li class="woocommerce-mini-cart-item mini_cart_item">
                                    ...
                                    <a class="black"><img src="<?php echo site_url().'static/page_front/images/logo/favico/android-chrome-192x192.png';?>">  Curso de <?php echo $items['name'];?></a>
