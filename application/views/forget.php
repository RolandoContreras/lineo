      ...
      <div class="breadcrumb-content ">
            <div class="breadcrumbs-wrapper container">
              <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li>
                    <span title="Recuperar contraseña">Recuperar contraseña</span>
                </li>
              </ul>
            </div>
          </div>
                      ...
                      <div class="vc_column-inner vc_custom_1503993250187">
                        <div class=wpb_wrapper>
                          <div class=thim-login>
                            <h4 class="subtitle">Recuperar Contraseña</h4>
                            <h2 class="title">Ingrese su Correo electronico</h2>
                            <form name="loginform" id="loginform" action="javascript:void(0);">
                              <p class="login-username">
                                  <input required type="email" placeholder="E-mail *" id="email" name="email" class="input required" size="20">
                              </p>
                              <div class="row">
                                  <div class="col">
                              ...
                              <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
                                <div class="wrap-fields">
                                  ...
                                  <p class="submit login-submit">
                                      <input type="submit" onclick="recuperar();" class="button button-primary button-large" value="Recuperar Contraseña">
                                  </p>
                            </form>
