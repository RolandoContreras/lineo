                            ...
                            <div class="stm_icon_box_responsive wpb_column vc_column_container vc_col-sm-12">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div class="icon_box vc_custom_1435665617764 stm_icon_box_hover_h3 dark module__0c0a3d70baf224e2ccbfc8d4a1bda10d clearfix">
                                                            <div class="icon_alignment_left">
                                                                ...
                                                                <div class="icon_text">
                                                                    ...
                                                                    <p><a href="tel:+51 998878636">+51 998878636</a></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="vc_column-inner vc_custom_1436790977027">
                                                    <div class="wpb_wrapper">
                                                        <div class="icon_box vc_custom_1435665538825 stm_icon_box_hover_h3 dark module__34cb81f88fe8563ebd21af4ed8dc05f9 clearfix">
                                                            <div class="icon_alignment_left">
                                                                <div class="icon vc_custom_1435657734647"> <i class="fa-icon-stm_icon_earth"></i></div>
                                                                <div class="icon_text">
                                                                    <h5 style="color:#555555"> Web:</h5>
                                                                    <p><a href="https://u-linex.com/">www.u-linex.com</a></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1435139343164">
                                            <div class="stm_sm_gutter_back stm_bottom_border wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-12">
                                                <div class="vc_column-inner vc_custom_1436791452718">
                                                    <div class="wpb_wrapper">
                                                        <div class="icon_box vc_custom_1435657717792 stm_icon_box_hover_h3 dark module__ff2614f5819099aa99f20d4bbe3d7bc2 clearfix">
                                                            <div class="icon_alignment_left">
                                                                <div class="icon vc_custom_1435657717791"> <i class="fa-icon-stm_icon_mail-o"></i></div>
                                                                <div class="icon_text">
                                                                    <h5 style="color:#555555"> Email:</h5>
                                                                    <p><a href="mailto:ulinex.corp@gmail.com">ulinex.corp@gmail.com</a></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <form action="javascript:void(0);" method="post" class="wpcf7-form" onsubmit="send_message();">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="form-group"> 
                                                            <span class="wpcf7-form-control-wrap message">
                                                                <input type="text" name="subject" id="subject" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-control"placeholder="ingresa el asunto" required/>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="form-group"> 
                                                            <span class="wpcf7-form-control-wrap message">
                                                                <textarea name="message" id="message" cols="40" rows="9" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form-control" placeholder="Ingresa el mensaje" required></textarea>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
